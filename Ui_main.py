...
"}")
        icon = QIcon()
        icon.addFile(u":/icon/res/close.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icon/res/minimize.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_2.setGeometry(QRect(20, 0, 301, 41))
        font = QFont()
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon/res/overview.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon/res/disk.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.enclosuresettingbutton.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icon/res/controller.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.controllersettingbutton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/res/display.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.oledsettingbutton.setIcon(icon5)
        ...
        self.centersettingbuttion = QPushButton(self.sidebar)
        self.centersettingbuttion.setObjectName(u"centersettingbuttion")
        self.centersettingbuttion.setGeometry(QRect(20, 340, 60, 60))
        self.centersettingbuttion.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon6 = QIcon()
        icon6.addFile(u":/icon/res/setting.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.centersettingbuttion.setIcon(icon6)
        self.centersettingbuttion.setIconSize(QSize(33, 38))
        self.centersettingbuttion.setAutoDefault(False)
        self.centersettingbuttion.setFlat(True)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icon/res/about.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_8.setGeometry(QRect(110, 70, 294, 80))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"R-SODIUM Ultra 2 Control Center", None))
...
#if QT_CONFIG(tooltip)
        self.centersettingbuttion.setToolTip(QCoreApplication.translate("Dialog", u"Center Setting", None))
#endif // QT_CONFIG(tooltip)
        self.centersettingbuttion.setText("")
#if QT_CONFIG(tooltip)
